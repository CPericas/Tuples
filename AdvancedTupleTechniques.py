...
#Problem Statement:
#You are managing the product catalogs for an online store. Each catalog is a tuple of products, and each product is a tuple containing 
# the product name and price. Merge multiple catalogs into a single tuple.
...
joined_catalog = catalog1 + catalog2
print(joined_catalog)